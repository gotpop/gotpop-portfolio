      ...
      <div className="flex items-center justify-between">
        <section className="social">
          <nav className="social__nav flex justify-center">
            <a className="social__link text-gray-600 hover:text-blue-700 transition" href="http://codepen.io/gotpop/">
            ...
            <a className="social__link text-gray-600 hover:text-blue-700 transition" href="http://uk.linkedin.com/in/gotpop">
              <span className="social__icon m-2 flex">
            ...
            <a className="social__link text-gray-600 hover:text-blue-700 transition" href="https://github.com/gotpop">
              <span className="social__icon m-2 flex">
