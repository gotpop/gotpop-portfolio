    ...
    <Container className="flex justify-center">
      <div className="flex items-center justify-between">
        <section className="social">
          <nav className="flex justify-center social__nav">
            <a className="text-gray-600 transition social__link hover:text-blue-700" href="http://codepen.io/gotpop/">
              <span className="flex m-2 social__icon">
            ...
            <a className="text-gray-600 transition social__link hover:text-blue-700" href="http://uk.linkedin.com/in/gotpop">
              <span className="flex m-2 social__icon">
            ...
            <a className="text-gray-600 transition social__link hover:text-blue-700" href="https://github.com/gotpop">
              <span className="flex m-2 social__icon">
